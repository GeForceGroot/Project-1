...
const Writer = () => {
    return (
        <>
            <div className='container' style={{ justifyContent: 'center', textAlign: "center", marginTop: '25px' }}>
                <h1 className="heading" style={{ marginTop: "10px" }}>Our To writer is here to help you out!💯</h1>
            </div>
            <div className="row" style={{transition: 'all 3s ease-in', margin: '60px', backgroundColor: 'darkkhaki', border: '1px solid gray', borderRadius: '10px 20px 30px 40px/30px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)',backgroundImage: 'linear-gradient(to top, #f3e7e9 0%, #e3eeff 99%, #e3eeff 100%)'
}}>
                ...
                <div className="col-md-6" style={{ marginTop: "50px", fontSize: "25px", color: "Highlight" }}>
                    <h4>Shruti Jain</h4>
